...
#define SwitchPin3 26  
#define SwitchPin4 25  
...
//CODE CẢM BIẾN KHÓI aka KHÍ GAS
void sendUptime()
{
  ...
  percent = map(value, 0, 1023, 100, 0); //chuyen gia tri cam bien sang %
  Blynk.virtualWrite(V1, percent); //truyen du lieu tu cam bien len Blynk app

  //neu gia tri cam bien ánh sang be hon 20% thi den bat, nguoc lai thi den tat
  if (percent <= 20) {
